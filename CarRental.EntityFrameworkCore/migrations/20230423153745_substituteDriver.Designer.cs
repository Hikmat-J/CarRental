...
namespace CarRental.EntityFrameworkCore.Migrations
{
    ...
    [Migration("20230423153745_substituteDriver")]
    partial class substituteDriver
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CarRental.Domain.Entities.Rent", b =>
                {
                    ...
                    b.Property<bool>("WithSubstituteDriver")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("CarRental.Domain.Entities.Rent", b =>
                {
                    ...
                    b.HasOne("CarRental.Domain.Entities.Driver", "SubstititeDriver")
                        .WithMany("SubstituteDriving")
            ...
            modelBuilder.Entity("CarRental.Domain.Entities.Driver", b =>
                {
                    ...
                    b.Navigation("SubstituteDriving");
                });
